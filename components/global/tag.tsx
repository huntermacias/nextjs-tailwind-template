...
import { TagColor } from './tagCreator2'; // Import TagColor type from your tagCreator file

interface TagComponentProps {
  title: string;
  colorName: TagColor;
  selectedColor?: (color: TagColor) => void;
}

const TagComponent: React.FC<TagComponentProps> = ({ colorName, title, selectedColor }) => {
  return (
    <div
      className={clsx('p-2 rounded-sm flex-shrink-0 text-xs cursor-pointer transition-all', {
